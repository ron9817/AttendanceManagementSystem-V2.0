...
#class Timetabledailyattendance(models.Model):
#    tt_id = models.IntegerField()
#    da_id = models.IntegerField()

#    class Meta:
#        managed = False
#        db_table = '$timeTableDailyAttendance'
...
#class Userproxymapping(models.Model):
#    user_id = models.IntegerField()
#    proxy_id = models.IntegerField()

#    class Meta:
#        managed = False
#        db_table = '$userProxyMapping'


#class Usertimetablemapping(models.Model):
#    user_id = models.IntegerField()
#    tt_id = models.IntegerField()

#   class Meta:
#        managed = False
#        db_table = '$userTimeTableMapping'
